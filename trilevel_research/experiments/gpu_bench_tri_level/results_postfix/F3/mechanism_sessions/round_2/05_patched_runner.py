...
class GpuBenchRunner:
    def __init__(
        ...
        # Add conservative mode flags and counters after simple_mode initialization
        self.conservative_mode = True
        self.min_step_fraction = 0.2
        self.conservative_iterations = 0
        _init_tracker = RelativeBPBTracker()
